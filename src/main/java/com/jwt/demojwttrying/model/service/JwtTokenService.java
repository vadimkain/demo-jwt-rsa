...
public class JwtTokenService {
    ...
    public String generateToken(final UserDetails userDetails) {
        ...
        return JWT.create().withSubject(userDetails.getUsername()).withIssuer("app").withIssuedAt(now).withExpiresAt(now.plusMillis(JWT_TOKEN_VALIDITY.toMillis())).sign(this.hmac512);
    }
